...
class SmartStraddle(TG_STD3_2DTE):
    def position_management(self, spot) -> None:
        ...
        if projected_gain > normalised_entry_point:
            ...
            # each leg must be an exact lot size
            # self.context.policy_variables["size_target"] = ((self.context.policy_variables["size_target"]/2)//self.context.lot_size)*self.context.lot_size*2
